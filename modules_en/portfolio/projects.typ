// ============================================================================
// FEATURED PROJECTS — Case studies for the luxury residential portfolio.
// ============================================================================

#import "theme.typ": *
#import "components.typ": eyebrow, section-title, project-case

#eyebrow("Selected works")
#section-title(
  [Featured projects.],
  subtitle: [Six case studies spanning custom homes, high-rise residences, and historic conversion.],
)

// ----------------------------------------------------------------------------
// 1. Discovery Land Company — Bahamas
// ----------------------------------------------------------------------------
#project-case(
  title: "Private Residences at Baker's Bay",
  ...
  outcome: [Delivered multiple homes meeting Discovery Land's exacting quality standards while reducing procurement delays by 30% relative to baseline island-construction benchmarks.],
  tags: (
...
// ----------------------------------------------------------------------------
// 2. Toth Construction — Seattle UHNW portfolio
// ----------------------------------------------------------------------------
#project-case(
  title: "Toth Construction — UHNW Residential Portfolio",
  location: "Seattle, WA",
  value: "$8M+",
  year: "2020 – 2022",
  role: "Project Manager",
  ...
  outcome: [Earned 3 client referrals and 2 repeat engagements during tenure — the clearest measure of trust in the luxury market — while delivering each residence on schedule.],
  tags: (
    "Ultra High Net Worth",
    "Custom Residential",
    "Client Experience",
...
// ----------------------------------------------------------------------------
// 3. 57th-Floor Custom Apartment Buildout
// ----------------------------------------------------------------------------
#project-case(
  title: "57th-Floor Custom Residence",
  location: "Seattle, WA",
  value: "High-rise",
  year: "2021",
  role: "Project Manager",
  ...
  outcome: [Delivered a fully custom residence without disruption to the surrounding building community, with zero complaints logged through building management.],
  tags: (
    "High-Rise",
    "Custom Interiors",
    "Occupied Building",
...
// ----------------------------------------------------------------------------
// 4. Temple Lofts Historic Conversion
// ----------------------------------------------------------------------------
#project-case(
  title: "Temple Lofts — Historic Masonic Temple",
  location: "Long Beach, CA",
  value: "$25M",
  year: "2006",
  role: "Project Engineer → Project Manager",
  scope: [Seismic retrofit and full renovation of a historic Masonic Temple, converting ceremonial spaces into luxury loft apartments while preserving character-defining interior features.],
  challenge: [A complex seismic retrofit of unreinforced masonry, integration of modern MEP systems without compromising ornate plasterwork, and a regulatory environment requiring historic tax credits and SHPO review.],
  approach: [Collaborated with preservation architects and structural engineers to develop retrofit solutions honoring the building's heritage; secured historic tax credits and Mills Act benefits; phased work to protect character-defining ceremonial spaces.],
  outcome: [Delivered on schedule with no regulatory delays; successful lease-up demonstrated the market appetite for historic luxury residences.],
  tags: (
    "Historic Conversion",
    "Adaptive Reuse",
    "Luxury Lofts",
...
// ----------------------------------------------------------------------------
// 5. The Alaska Building Renovation
// ----------------------------------------------------------------------------
#project-case(
  ...
  outcome: [Recognized with two national awards: the 2009 ABC Eagle Award for Best Historic Restoration, and Northwest Construction's Best Historic Renovation.],
  tags: (
...
// ----------------------------------------------------------------------------
// 6. 2210 Eastlake — Boutique Multifamily
// ----------------------------------------------------------------------------
#project-case(
  ...
  outcome: [Delivered on schedule with zero recordable safety incidents across the 24-month project, and strong subcontractor relationships preserved throughout.],
  tags: (
